...
class ApartDetails extends StatefulWidget {
  ...
  String?Bathrooms;
  String?Price;
  ApartDetails({super.key,this.Bedrooms,this.Price,this.Bathrooms,
  ...
  @override
  State<ApartDetails> createState() => _ApartDetailsState();
}
class _ApartDetailsState extends State<ApartDetails> {
