...
class Housepage extends StatefulWidget {
  ...
  var description;
  String?imgurl_pref;
   Housepage({super.key,this.bedrooms,this.bathrooms,this.description,
   this.name,this.phone,this.email,this.price,this.id,this.imgurl_pref});
  @override
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text("For You",style: TextStyle(fontSize: 16),),
                  ],
                ),SizedBox(height: 15,),
                Container(
                    height: 290,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Best For You",style: TextStyle(fontSize: 16),) ,
                  ],
                ),
                SizedBox(height: 15,),
                Container(
                  ...
                  width: 400,
                  child: StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection('properties').where('title',isEqualTo: 'Houses').snapshots(),
                    builder: (context,snapshot){
...
//             .where('name', isEqualTo: 'Orchad House')
//             .snapshots(),
//         builder: (context, snapshot) {
//           if (snapshot.connectionState == ConnectionState.waiting) {
//             return Center(
...
//
// void main() {
//   runApp(MaterialApp(home: PropertyList()));
// }
