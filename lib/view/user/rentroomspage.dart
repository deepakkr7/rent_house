...
import 'package:rent_house/view/user/rentroomdetails.dart';
...
class RentroomPage extends StatefulWidget {
  ...
  var description;
  String?imgurl_pref;
  RentroomPage({this.description,this.price,this.bedrooms,this.bathrooms,
    this.phone,this.name,this.id,this.imgurl_pref,this.email,
  super.key});
  @override
  State<RentroomPage> createState() => _RentroomPageState();
}
          ...
          child: SingleChildScrollView(
            ...
            Container(
              ...
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance.collection('vendorservice').where('title',isEqualTo: 'Rent Rooms').snapshots(),
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder:(context,index){
                          return Padding(padding: EdgeInsets.all(8),
                            child: InkWell(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>RentroomDetails(
            ...
            SizedBox(height: 15,),
                Container(
                    ...
                    width: 400,
                    child: StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance.collection('properties').where('title',isEqualTo: 'Rent Rooms').snapshots(),
                        builder: (context,snapshot){
