...
import 'package:rent_house/view/user/villadetails.dart';
...
class VillaPage extends StatefulWidget {
  ...
  var description;
  String?imgurl_pref;
 VillaPage({this.bathrooms,this.bedrooms,this.price,this.description,
              ...
              children: [
                ...
                Container(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection('vendorservice').where('title',isEqualTo: 'Villa').snapshots(),
                        ...
                        return ListView.builder(
                            ...
                            itemBuilder:(context,index){
                              return Padding(padding: EdgeInsets.all(8),
                                child: InkWell(
                                  onTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>VillaDetails(
                ...
                Container(
                    ...
                    width: 400,
                    child: StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance.collection('properties').where('title',isEqualTo: 'Villa').snapshots(),
                        builder: (context,snapshot){
