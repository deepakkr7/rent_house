...
import 'package:rent_house/view/user/flatdetails.dart';
...
class FlatPage extends StatefulWidget {
  ...
  var description;
  String?imgurl_pref;
  FlatPage({this.bathrooms,this.bedrooms,this.price,this.description,
    this.phone,this.name,this.id,this.imgurl_pref,this.email,super.key});
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection('vendorservice').where('title',isEqualTo: 'Flat').snapshots(),
                        ...
                        return ListView.builder(
                            ...
                            itemBuilder:(context,index){
                              return Padding(padding: EdgeInsets.all(8),
                                child: InkWell(
                                  onTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>FlatDetails(
                ...
                Container(
                    ...
                    width: 400,
                    child: StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance.collection('properties').where('title',isEqualTo: 'Flat').snapshots(),
                        builder: (context,snapshot){
