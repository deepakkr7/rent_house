...
class RentroomDetails extends StatefulWidget {
  String?title;
  String?id;
  ...
  String?Bathrooms;
  String?Price;
  RentroomDetails({super.key,this.Price,this.Bedrooms,this.Bathrooms,
  ...
  @override
  State<RentroomDetails> createState() => _RentroomDetailsState();
}
class _RentroomDetailsState extends State<RentroomDetails> {
