              ...
              child: Column(
                ...
                children: [
                  TextFormField(
                    ...
                    decoration: InputDecoration(hintText: "Vendor Name",icon: Icon(Icons.person,color: Colors.blue,) ),
                  ),
                  SizedBox(height: 10,),
                  TextFormField(
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(hintText: "Place",icon: Icon(Icons.place_outlined,color: Colors.blue,)),
                  ),
                  SizedBox(height: 10,),
                  TextFormField(
                    validator: (value){
                    ...
                    decoration: InputDecoration(hintText: "Email",icon: Icon(Icons.alternate_email,color: Colors.blue,)),
                  ),
                  SizedBox(height: 10,),
                  TextFormField(
                    validator: (value){
